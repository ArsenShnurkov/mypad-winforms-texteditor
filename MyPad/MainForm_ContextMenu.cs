...
namespace MyPad
{
    public partial class MainForm : Form
    {
        ...
        private void filepathnameToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (etb != null)
            {
                Program.TextClipboard.CopyTextToClipboard(etb.ToolTipText, false);
            }
        }
        ...
        private void foldernameToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (etb != null)
            {
                FileInfo fi = new FileInfo(etb.ToolTipText);
                if (etb.ToolTipText.Contains(Path.DirectorySeparatorChar))
                {
